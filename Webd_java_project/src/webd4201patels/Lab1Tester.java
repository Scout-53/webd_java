package webd4201patels;  //change this to make the class part of your package
/**
...
import java.util.*;
/** 
 * Tester java file for the lab and just commenting since it was generating java doc errors
 * */
public class Lab1Tester {
	 ...
	 * @throws InvalidIdException throws ID invalid exception
	 * @throws InvalidPasswordException throws invalid Password exception
	 * @throws InvalidNameException throws invalid Name exception
	 */
