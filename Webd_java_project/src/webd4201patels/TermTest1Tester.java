    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                ...
                int newExt = 6333;
                System.out.println("\n" + aFaculty.getFirstName() + " " + aFaculty.getLastName()
                        + " is changing offices and getting a new phone number.\n "
                        + "currently he is in " + aFaculty.getOffice() + " with the extension x"
                        + aFaculty.getExtension() + "\n");
            ...
            try {
                ...
                aFaculty.delete();
                System.out.println(
                        "Faculty record with id " + aFaculty.getId() + " successfully removed from the database.\n");
            } catch (NotFoundException e) {
                System.out.println(e);
            }
        } catch (Exception e) {
